export const createGrpcGateWayClient = async ({
  ...
  return {
    ...
    publicawesome: {
      stargaze: {
        alloc: {
          v1beta1: new (await import("../stargaze/alloc/v1beta1/query.rpc.Query")).QueryClientImpl(endpoint)
        },
        claim: {
          v1beta1: new (await import("../stargaze/claim/v1beta1/query.rpc.Query")).QueryClientImpl(endpoint)
        }
      }
    }
  };
