...
export const secretAminoConverters = { ...secretComputeV1beta1MsgAmino.AminoConverter,
  ...secretIntertxV1beta1TxAmino.AminoConverter
};
export const secretProtoRegistry: ReadonlyArray<[string, GeneratedType]> = [...secretComputeV1beta1MsgRegistry.registry, ...secretIntertxV1beta1TxRegistry.registry];
export const getSigningSecretClientOptions = ({
  ...
  const aminoTypes = new AminoTypes({ ...secretAminoConverters
  });
  return {
    registry,
    aminoTypes
