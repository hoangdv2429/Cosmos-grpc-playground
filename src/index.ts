...
function makeSignerInfos(
  ...
  export interface Msg {
    ...
    toAmino(msg: any): Promise<AminoMsg>;
  }
//---
...
// async function signAmino(
  ...
  //       return MsgSend.toAmino(msg as unknown as MsgSend);
  //     }),
  //   );
  ...
  //           const asProto = await MsgSend.toProto(msg);
  //           return asProto;
  //         }),
  //       ),
  //       memo: memo,
...
const main = async () => {
    ...
    const signed_tx = await signClient.sign('osmo1xa382g55fvyyp3rmdsk548qpdzmh6p37ajdk99', [msg], fee, 'so tired', signerData);
