...
export const createGrpcWebClient = async ({
  ...
  return {
    ...
    ibc: {
      applications: {
        transfer: {
          v1: new (await import("./applications/transfer/v1/query.rpc.Query")).QueryClientImpl(grpcWeb)
        }
      },
      core: {
        channel: {
          v1: new (await import("./core/channel/v1/query.rpc.Query")).QueryClientImpl(grpcWeb)
        },
        client: {
          v1: new (await import("./core/client/v1/query.rpc.Query")).QueryClientImpl(grpcWeb)
        },
        connection: {
          v1: new (await import("./core/connection/v1/query.rpc.Query")).QueryClientImpl(grpcWeb)
        },
        port: {
          v1: new (await import("./core/port/v1/query.rpc.Query")).QueryClientImpl(grpcWeb)
        }
      }
    }
  };
