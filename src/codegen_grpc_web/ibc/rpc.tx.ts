...
export const createRPCMsgClient = async ({
  ...
  return {
    ...
    ibc: {
      applications: {
        transfer: {
          v1: new (await import("./applications/transfer/v1/tx.rpc.msg")).MsgClientImpl(grpcWeb)
        }
      },
      core: {
        channel: {
          v1: new (await import("./core/channel/v1/tx.rpc.msg")).MsgClientImpl(grpcWeb)
        },
        client: {
          v1: new (await import("./core/client/v1/tx.rpc.msg")).MsgClientImpl(grpcWeb)
        },
        connection: {
          v1: new (await import("./core/connection/v1/tx.rpc.msg")).MsgClientImpl(grpcWeb)
        }
      }
    }
  };
