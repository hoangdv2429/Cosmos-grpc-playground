...
export const createRPCMsgClient = async ({
  ...
  return {
    ...
    publicawesome: {
      stargaze: {
        alloc: {
          v1beta1: new (await import("../stargaze/alloc/v1beta1/tx.rpc.msg")).MsgClientImpl(grpcWeb)
        },
        claim: {
          v1beta1: new (await import("../stargaze/claim/v1beta1/tx.rpc.msg")).MsgClientImpl(grpcWeb)
        }
      }
    }
  };
