...
export const GenesisDowntimeEntry = {
  ...
  fromSDK(object: GenesisDowntimeEntrySDKType): GenesisDowntimeEntry {
    return {
      duration: isSet(object.duration) ? downtimeFromJSON(object.duration) : -1,
      lastDowntime: object.last_downtime ? Timestamp.fromSDK(object.last_downtime) : undefined
    };
  },
  toSDK(message: GenesisDowntimeEntry): GenesisDowntimeEntrySDKType {
    const obj: any = {};
    message.duration !== undefined && (obj.duration = downtimeToJSON(message.duration));
    message.lastDowntime !== undefined && (obj.last_downtime = message.lastDowntime ? Timestamp.toSDK(message.lastDowntime) : undefined);
    return obj;
  },
...
export const GenesisState = {
  ...
  fromSDK(object: GenesisStateSDKType): GenesisState {
    return {
      ...
      lastBlockTime: object.last_block_time ? Timestamp.fromSDK(object.last_block_time) : undefined
    };
  },
  toSDK(message: GenesisState): GenesisStateSDKType {
    ...
    message.lastBlockTime !== undefined && (obj.last_block_time = message.lastBlockTime ? Timestamp.toSDK(message.lastBlockTime) : undefined);
    return obj;
  },
